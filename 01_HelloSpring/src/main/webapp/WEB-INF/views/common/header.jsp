...
<%-- 						<li class="nav-item">
			        ...
			        <button class="btn btn-outline-success my-2 my-sm-0" type="button" onclick="location.href='${pageContext.request.contextPath}/member/memberView.do?userId=${ loginMember.userId }'">마이페이지</button>
					</c:if>
				</div>
			</nav>
		</header>
